...
class PlayGameState(GameState):
	...
	def initialize(self):
		...
		bullet_renderer = BulletView(self.player_controller.bullets, 'images/greenbullet.png')
		alienbullet_renderer = BulletView(self.swarm_controller.bullets, 'images/alienbullet.png')
		...
		explosion_view = ExplosionView(explosion_controller.list.explosions, 'images/explosion_me.png', 32, 32)
